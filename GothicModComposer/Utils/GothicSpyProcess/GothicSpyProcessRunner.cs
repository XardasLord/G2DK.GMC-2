...
namespace GothicModComposer.Utils.GothicSpyProcess
{
	public class GothicSpyProcessRunner
	{
		...
		public GothicSpyProcessRunner()
		{
			_gothicSpyProcessInstance = new GothicSpyProcess();
		}
		...
		private Thread CreateThread()
		{
			return new Thread(() =>
			{
				Application.Run(_gothicSpyProcessInstance);
			})
			{
				IsBackground = true
			};
		...
		private static bool IsZSpyRunning()
		{
			return Process.GetProcessesByName(GothicSpyProcessName).Length != 0;
		}
	}
}