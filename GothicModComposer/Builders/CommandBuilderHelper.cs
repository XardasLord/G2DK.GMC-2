...
namespace GothicModComposer.Builders
{
    public static class CommandBuilderHelper
    {
        ...
        private static readonly Dictionary<string, Func<IProfile, ICommand>> Commands = new()
        {
            ...
            {
                CopyEssentialAssetFilesFromBackupCommand,
                profile => new CopyEssentialAssetFilesFromBackupCommand(profile)
            },
            ...
            {
                ExecuteGothicKillOnLoadCommand,
                profile => new ExecuteGothicCommand(profile,
                    GothicModComposer.Commands.ExecuteGothicCommand.WorldLoadedMessage)
            },
        ...
        public static List<ICommand> ParseCommands(List<string> stringCommands, IProfile profile)
        {
            ...
            stringCommands.ForEach(commandName => { commands.Add(FromString(profile, commandName)); });
