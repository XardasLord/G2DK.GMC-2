    ...
    public static class IniOverrideHelper
    {
        public static List<IniOverride> DefaultIniOverrideKeys
            => new()
            {
                ...
                new IniOverride { Key = "highlightInteractFocus", Value = "0", Section = "GAME", DisplayAs = DataGridColumnType.TextBox },
                new IniOverride { Key = "useGothic1Controls", Value = "1", Section = "GAME", DisplayAs = DataGridColumnType.ComboBox, AvailableValues = new List<string> { "0", "1" } },
                new IniOverride { Key = "disallowVideoInput", Value = "0", Section = "GAME", DisplayAs = DataGridColumnType.ComboBox, AvailableValues = new List<string> { "0", "1" } },
                new IniOverride { Key = "keyDelayRate", Value = "150", Section = "GAME", DisplayAs = DataGridColumnType.TextBox },
                new IniOverride { Key = "enableJoystick", Value = "0", Section = "GAME", DisplayAs = DataGridColumnType.ComboBox, AvailableValues = new List<string> { "0", "1" } },
                new IniOverride { Key = "keyDelayFirst", Value = "0", Section = "GAME", DisplayAs = DataGridColumnType.ComboBox, AvailableValues = new List<string> { "0", "1" } },
                new IniOverride { Key = "subTitles", Value = "1", Section = "GAME", DisplayAs = DataGridColumnType.ComboBox, AvailableValues = new List<string> { "0", "1" } },
                new IniOverride { Key = "subTitlesAmbient", Value = "1", Section = "GAME", DisplayAs = DataGridColumnType.ComboBox, AvailableValues = new List<string> { "0", "1" } },
                new IniOverride { Key = "subTitlesPlayer", Value = "1", Section = "GAME", DisplayAs = DataGridColumnType.ComboBox, AvailableValues = new List<string> { "0", "1" } },
                new IniOverride { Key = "subTitlesNoise", Value = "0", Section = "GAME", DisplayAs = DataGridColumnType.ComboBox, AvailableValues = new List<string> { "0", "1" } },
                new IniOverride { Key = "invMaxColumns", Value = "5", Section = "GAME", DisplayAs = DataGridColumnType.TextBox },
                new IniOverride { Key = "invMaxRows", Value = "0", Section = "GAME", DisplayAs = DataGridColumnType.TextBox },
                new IniOverride { Key = "invSplitScreen", Value = "1", Section = "GAME", DisplayAs = DataGridColumnType.ComboBox, AvailableValues = new List<string> { "0", "1" } },
                new IniOverride { Key = "invCatOrder", Value = "COMBAT,POTION,FOOD,ARMOR,MAGIC,RUNE,DOCS,OTHER,NONE", Section = "GAME", DisplayAs = DataGridColumnType.TextBox },
                new IniOverride { Key = "gametextAutoScroll", Value = "1000", Section = "GAME", DisplayAs = DataGridColumnType.TextBox },
                new IniOverride { Key = "usePotionKeys", Value = "0", Section = "GAME", DisplayAs = DataGridColumnType.ComboBox, AvailableValues = new List<string> { "0", "1" } },
